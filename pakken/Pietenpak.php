<?php
    ...
    $dbh = $dbh->prepare("SELECT * FROM pak JOIN status_pak ON pak.PakID = status_pak.PakID JOIN foto_pak ON pak.PakID=foto_pak.PakID WHERE Type='piet'");
    $dbh->execute();
...
<div class="container">
    ...
    <table class="table">
        ...
        <?php foreach($pakken as $pak): ?>
                <tr>
                    <td><img src="<?php print_r ($pak['FotoID']);?>" alt="..." class="img-thumbnail"></td>
