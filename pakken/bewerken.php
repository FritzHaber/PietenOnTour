        ...
        if (!empty($_POST['pakid'])) {      // && !empty($_POST['profiel_foto'])
            if (is_uploaded_file($_FILES["profiel_foto"]["tmp_name"])) {
                ...
                elseif ($_FILES["profiel_foto"]["size"] > 500000) {
                    ...
                    $pak = $costume->pak_bewerken($_POST, $pak_id, $foto = true);
                    $pak = $costume->pak_ophalen_pakid($pak_id);
                ...
                $pak = $costume->pak_bewerken($_POST, $pak_id, $foto = false);
                $pak = $costume->pak_ophalen_pakid($pak_id);
                $_SESSION['flash'] = array(
                    'type' => 'success',
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="profiel_foto" type="file" class="form-control" id="profiel_foto" value="<?php echo $pak["foto_id"] ?>">
...
-->
        ...
        //                exit;
                    ...
                    $pak = $costume->pak_bewerken($_POST, $pak_id);
                    $pak = $costume->pak_ophalen_pakid($pak_id);
                        if (move_uploaded_file($_FILES["profiel_foto"]["tmp_name"], $target_file)){// verplaatst de foto naar uploads           !empty($pak) && 
                            if ($_POST["type"]=="piet") {
                                $_SESSION['flash'] = array(
        ...
        if (isset($_POST["opslaan_onderdelen"])){
        $pak = $costume->nieuw_pak_onderdelen($_POST);
            if (isset($pak['pak_id'])) {
                $_SESSION['flash'] = array(
                'type' => 'success',
                'message' => 'De onderdelen zijn succesvol toegevoegd.'
...
<html>
    ...
    <body>
        ...
        <div class="tab">
          <button class="tablinks" onclick="openCity(event, 'Details')" id="<?php if(empty($_SESSION['volgende'])) echo 'defaultOpen';?>">Details</button>
          <button class="tablinks" onclick="openCity(event, 'Onderdelen')" id="<?php if(!empty($_SESSION['volgende'])) echo 'defaultOpen';?>">Onderdelen</button>
          <button class="tablinks" onclick="openCity(event, 'Log')">Log</button>
          <?php $_SESSION['volgende'] = '';?>
        </div>
<!--        <h1>Pak bewerken</h1>-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="maat" class="col-sm-3 col-form-label">Maat</label>
                                <select name="maat" class="form-control col-sm-9" id="maat">
                                    <option value="s"<?php if($pak["maat"]=="s") echo 'selected="selected"'; ?>>S</option>
                                    <option value="m"<?php if($pak["maat"]=="m") echo 'selected="selected"'; ?>>M</option>
                                    <option value="x"<?php if($pak["maat"]=="x") echo 'selected="selected"'; ?>>X</option>
                                    <option value="xl"<?php if($pak["maat"]=="xl") echo 'selected="selected"'; ?>>XL</option>
                                </select>
                            </div>
                            <div class="form-group row">
                                <label for="kleur" class="col-sm-3 col-form-label">Kleur</label>
                                <select name="kleur" class="form-control col-sm-9" id="kleur">
                                    <option value="Rood/Zwart"<?php if($pak["kleur"]=="Rood/Zwart") echo 'selected="selected"'; ?>>Rood/Zwart</option>
                                    <option value="Paars/Zwart"<?php if($pak["kleur"]=="Paars/Zwart") echo 'selected="selected"'; ?>>Paars/Zwart</option>
                                    <option value="Groen/Zwart"<?php if($pak["kleur"]=="Groen/Zwart") echo 'selected="selected"'; ?>>Groen/Zwart</option>
                                    <option value="Geel/Zwart"<?php if($pak["kleur"]=="Geel/Zwart") echo 'selected="selected"'; ?>>Geel/Zwart</option>
                                </select>
                            </div>
                            <div class="form-group row">
                                <label for="geslacht" class="col-sm-3 col-form-label">Geslacht</label>
                                <select name="geslacht" class="form-control col-sm-9" id="geslacht">
                                    <option value="Man"<?php if($pak["geslacht"]=="Man") echo 'selected="selected"'; ?>>Man</option>
                                    <option value="Vrouw"<?php if($pak["geslacht"]=="Vrouw") echo 'selected="selected"'; ?>>Vrouw</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="beschadigd" class="col-sm-3 col-form-label">Beschadigd</label>
                                <div class="col-sm-9">
                                    <input name="beschadigd" value="beschadigd" <?php if($pak["omschrijving"]=="beschadigd") echo 'checked="checked"'; ?> type="checkbox" class="form-control" id="beschadigd">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="type" class="col-sm-3 col-form-label">Type</label>
                                <select name="type" class="form-control col-sm-9" id="type">
                                    <option value="piet"<?php if($pak["type"]=="piet") echo 'selected="selected"'; ?>>Piet</option>
                                    <option value="sinterklaas"<?php if($pak["type"]=="sinterklaas") echo 'selected="selected"'; ?>>Sinterklaas</option>
                                </select>
                            </div>
                            <div class="form-group row">
                                <label for="profiel_foto" class="col-sm-3 col-form-label">Profiel foto</label>
                                <div class="col-sm-9">
                                    ...
                                    <img class="img-thumbnail" id="blah" src="http://<?php echo $pak["foto_id"]?>" alt="your image" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="Onderdelen" class="tabcontent">
                <form action="bewerken.php?id=<?php echo $pak_id ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="vastonderdeel1" class="col-sm-3 col-form-label">Vastonderdeel 1</label>
                                <div class="col-sm-9">
                                    <input name="vastonderdeel1" required type="text" class="form-control" id="vastonderdeel1"
                                           value="<?php echo isset($pak["vastonderdeel1"]) ? $pak["vastonderdeel1"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="vastonderdeel2" class="col-sm-3 col-form-label">Vastonderdeel 2</label>
                                <div class="col-sm-9">
                                    <input name="vastonderdeel2" required type="text" class="form-control" id="vastonderdeel2"
                                           value="<?php echo isset($pak["vastonderdeel2"]) ? $pak["vastonderdeel2"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="vastonderdeel3" class="col-sm-3 col-form-label">Vastonderdeel 3</label>
                                <div class="col-sm-9">
                                    <input name="vastonderdeel3" required type="text" class="form-control" id="vastonderdeel3"
                                           value="<?php echo isset($_POST["vastonderdeel3"]) ? $_POST["vastonderdeel3"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel4" class="col-sm-3 col-form-label">Onderdeel 4</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel4" type="text" class="form-control" id="onderdeel4"
                                           value="<?php echo isset($_POST["onderdeel4"]) ? $_POST["onderdeel4"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel5" class="col-sm-3 col-form-label">Onderdeel 5</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel5" type="text" class="form-control" id="onderdeel5"
                                           value="<?php echo isset($_POST["onderdeel5"]) ? $_POST["onderdeel5"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel6" class="col-sm-3 col-form-label">Onderdeel 6</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel6" type="text" class="form-control" id="onderdeel6"
                                           value="<?php echo isset($_POST["onderdeel6"]) ? $_POST["onderdeel6"] : ''; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="onderdeel7" class="col-sm-3 col-form-label">Onderdeel 7</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel7" type="text" class="form-control" id="onderdeel7"
                                           value="<?php echo isset($_POST["onderdeel7"]) ? $_POST["onderdeel7"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel8" class="col-sm-3 col-form-label">Onderdeel 8</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel8" type="text" class="form-control" id="onderdeel8"
                                           value="<?php echo isset($_POST["onderdeel8"]) ? $_POST["onderdeel8"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel9" class="col-sm-3 col-form-label">Onderdeel 9</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel9" type="text" class="form-control" id="onderdeel9"
                                           value="<?php echo isset($_POST["onderdeel9"]) ? $_POST["onderdeel9"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel10" class="col-sm-3 col-form-label">Onderdeel 10</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel10" type="text" class="form-control" id="onderdeel10"
                                           value="<?php echo isset($_POST["onderdeel10"]) ? $_POST["onderdeel10"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel11" class="col-sm-3 col-form-label">Onderdeel 11</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel11"type="text" class="form-control" id="onderdeel11"
                                           value="<?php echo isset($_POST["onderdeel11"]) ? $_POST["onderdeel11"] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="onderdeel12" class="col-sm-3 col-form-label">Onderdeel 12</label>
                                <div class="col-sm-9">
                                    <input name="onderdeel12" type="text" class="form-control" id="onderdeel12"
                                           value="<?php echo isset($_POST["onderdeel12"]) ? $_POST["onderdeel12"] : ''; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
