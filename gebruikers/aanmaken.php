<?php
    ...
    if (isset($_POST['opslaan'])) {
        if (!empty($_POST['mail']) && !empty($_POST['voornaam']) && !empty($_POST['achternaam']) &&
            ...
            // Checken of het een geldig email adres is
            if (filter_var($_POST['mail'], FILTER_VALIDATE_EMAIL)) {
                ...
                if (isset($gebruiker['message'])) {
                    ...
                    // als er iets anders gebeurd wat niet klopt
                } else {
                    $error = array(
                        'type' => 'danger',
                ...
                // error wanener er geen geldig email is ingevuld
            } else {
                $error = array(
                    'type' => 'danger',
            ...
            // wanneer niet alle velden (juist) zijn ingevuld
        } else {
            $error = array(
                'type' => 'danger',
